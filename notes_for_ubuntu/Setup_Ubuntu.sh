...
#sudo apt install git i3 ranger vim neovim terminator inkscape neofetch rxvt-unicode obs-studio brightnessctl deepin-screenshot gdebi-core libudunits2-dev libgdal-dev r-base fcitx fcitx-googlepinyin perl
#
...
#cp -r /home/synferlo/git/Vim/notes_for_ubuntu/some_backup/nvim_laptop/ranger $HOME/.config/
...
#myFile=$HOME/.config/
#i3wmpath=/home/synferlo/git/Vim/notes_for_ubuntu/some_backup/nvim_laptop/i3
